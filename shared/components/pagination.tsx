          ...
          <div className="flex-1">
            <div className="relative">
              <input
                ...
                className="w-full rounded-lg border border-border bg-muted px-4 py-2.5 text-sm placeholder-muted-foreground transition-all focus:border-primary focus:ring-2 focus:ring-primary/20 focus:outline-none"
              />
              <IconSearch className="absolute top-1/2 right-3 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
            </div>
          </div>
