...
export default function SignupPage({ children }: SignupPageProps) {
    ...
    <div className="flex flex-col px-6 py-8 sm:px-2 lg:px-2 lg:py-10">
      <div className="flex justify-end text-sm">
        <span className="text-muted-foreground">
          ...
          <Button
            className="cursor-pointer font-semibold text-foreground underline duration-75 hover:scale-x-110"
            variant="link"
                ...
                return (
                  <Field>
                    ...
                    <InputCustomIcon
                      ...
                      className="h-12 border-muted bg-muted text-foreground transition-all duration-200 placeholder:text-muted-foreground focus:border-primary focus:ring-2 focus:ring-primary/20"
                ...
                return (
                  <Field>
                    ...
                    <InputCustomIcon
                      ...
                      onChange={(e) => field.handleChange(e.target.value)}
                      aria-invalid={isInvalid}
                      icon={<IconUserCircle className="mt-2 h-4 w-4" />}
                    />
                    <p className="text-xs text-muted-foreground">
